...
|----|------|-----|-----|-----|--------|---------|-------|-----------|
| GOIASTECH-2     | Alpine+FRR | 10.250.0.31 | 65031 | localhost:43022 | -               | root  | lab123 | 10.11.0.0/24 |
| CONTABILIDADE-2 | Alpine+FRR | 10.250.0.41 | 65041 | localhost:44022 | -               | root  | lab123 | 10.51.0.0/24 |
| MIKROTIK-002    | RouterOS   | 10.250.0.51 | 65101 | localhost:45022 | localhost:45091 | admin | admin  | (config manual) |

API RouterOS do MIKROTIK-002: localhost:45028.
GOIASTECH-2 e CONTABILIDADE-2 sobem com BGP pronto (peer com a VIVO).
MIKROTIK-002 e RouterOS: configure colando um .rsc (use mikrotik-001.rsc
como base, trocando o IP para 10.250.0.51 e o AS para 65101).
